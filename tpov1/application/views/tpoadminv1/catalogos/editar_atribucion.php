...
<?php
    ...
    {
        if($atribucion['active'] == $lista_estatus_ids[$z]){
...
<section class="content">
    ...
    <div class="row">
        <form role="form" method="post" action="<?php echo base_url(); ?>index.php/tpoadminv1/catalogos/catalogos/validate_editar_atribucion" enctype="multipart/form-data" >
            <div class="box box-primary">
                <div class="box-header">
                </div><!-- /.box-header -->
                <div class="box-body">
                    <input type="hidden" value="<?php echo $atribucion['id_so_atribucion'] ?>" class="form-control" name="id_so_atribucion"/> 
                    <div class="form-group">
                        <label>Funci&oacute;n del sujeto obligado*</label>
                        <?php $class = "form-control";
                            echo form_input(array('type' => 'text', 'name' => 'nombre_so_atribucion', 'value' => $atribucion['nombre_so_atribucion'], 'class' => $class)); ?>
                    </div>
                    <div class="form-group">
                        <label>Estatus*</label>
