...
<?php
    ...
    {
        if($sexo['active'] == $lista_estatus_ids[$z]){
...
<section class="content">
    ...
    <div class="row">
        <form role="form" method="post" action="<?php echo base_url(); ?>index.php/tpoadminv1/catalogos/poblacion_objetivo/validate_editar_sexo" enctype="multipart/form-data" >
            <div class="box box-primary">
                <div class="box-header">
                </div><!-- /.box-header -->
                <div class="box-body">
                    <input type="hidden" value="<?php echo $sexo['id_poblacion_sexo']?>" class="form-control" name="id_poblacion_sexo"/>
                    <div class="form-group">
                        <label>Segmentaci&oacute;n por sexo*</label>
                        <?php $class = "form-control";
                            echo form_input(array('type' => 'text', 'name' => 'nombre_poblacion_sexo', 'value' => $sexo['nombre_poblacion_sexo'], 'class' => $class)); ?>
                    </div>
                    <div class="form-group">
                        <label>Estatus*</label>
