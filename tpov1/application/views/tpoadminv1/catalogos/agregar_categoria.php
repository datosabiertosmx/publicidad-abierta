...
<?php
    ...
    for($z = 0; $z < sizeof($lista_estatus_ids); $z++)
    {
        if( $categoria_estatus == 'null' )
        {
            ...
            if( $lista_estatus_ids[$z] == $categoria_estatus ){
                $sel_estatus .= '<option value="'.$lista_estatus_ids[$z].'" selected>' . $lista_estatus[$z] . '</option>';
            }else{
                $sel_estatus .= '<option value="'.$lista_estatus_ids[$z].'">' . $lista_estatus[$z] . '</option>';
            }
    ...
    {
        if($id_clasificacion == $clasificacion[$z]['id_servicio_clasificacion']){
...
<section class="content">
    ...
    <div class="row">
        <form role="form" method="post" action="<?php echo base_url(); ?>index.php/tpoadminv1/catalogos/servicios/validate_agregar_categoria" enctype="multipart/form-data" >
            <div class="box box-primary">
                <div class="box-header">
                </div><!-- /.box-header -->
                <div class="box-body">
                    <input type="hidden" value="" class="form-control" name="id_servicio_categoria"/>
                    ...
                    <div class="form-group">
                        ...
                        <?php $class = "form-control";
                            echo form_input(array('type' => 'text', 'name' => 'nombre_servicio_categoria', 'value' => $categoria_nombre, 'class' => $class)); ?>
                    </div>
                    <div class="form-group">
                        <label>T&iacute;tulo gr&aacute;fica*</label>
                        <?php $class = "form-control";
                            echo form_input(array('type' => 'text', 'name' => 'titulo_grafica', 'value' => $categoria_titulo, 'class' => $class)); ?>
                    </div>
                    <div class="form-group">
                        <label>Color gr&aacute;fica*</label>
                        <?php $class = "form-control";
                            echo form_input(array('type' => 'text', 'name' => 'color_grafica', 'value' => $categoria_color, 'class' => $class)); ?>
                    </div>
                    <div class="form-group">
                        <label>Estatus*</label>
