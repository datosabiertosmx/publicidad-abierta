...
<?php
    ...
    {
        if($liga['active'] == $lista_estatus_ids[$z]){
...
<section class="content">
    ...
    <div class="row">
        <form role="form" method="post" action="<?php echo base_url(); ?>index.php/tpoadminv1/catalogos/catalogos/validate_editar_liga" enctype="multipart/form-data" >
            <div class="box box-primary">
                <div class="box-header">
                </div><!-- /.box-header -->
                <div class="box-body">
                    <input type="hidden" value="<?php echo $liga['id_tipo_liga'] ?>" class="form-control" name="id_tipo_liga"/> 
                    <div class="form-group">
                        <label>Tipo de liga*</label>
                        <?php $class = "form-control";
                            echo form_input(array('type' => 'text', 'name' => 'tipo_liga', 'value' => $liga['tipo_liga'], 'class' => $class)); ?>
                    </div>
                    <div class="form-group">
                        <label>Estatus*</label>
                ...
                <div class="box-footer">
                    ...
                    <?php echo anchor("tpoadminv1/catalogos/catalogos/busqueda_ligas", "<button class='btn btn-default' type='button'>Regresar</button></td>"); ?>
                </div>     
            </div><!-- /.box -->    
            <?php 
