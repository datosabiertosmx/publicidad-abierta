...
<?php
    ...
    for($z = 0; $z < sizeof($lista_estatus_ids); $z++)
    {
        if( $tema_estatus == 'null' )
        {
            ...
            if( $lista_estatus_ids[$z] == $tema_estatus ){
                $sel_estatus .= '<option value="'.$lista_estatus_ids[$z].'" selected>' . $lista_estatus[$z] . '</option>';
            }else{
                $sel_estatus .= '<option value="'.$lista_estatus_ids[$z].'">' . $lista_estatus[$z] . '</option>';
            }
...
<section class="content">
    ...
    <div class="row">
        <form role="form" method="post" action="<?php echo base_url(); ?>index.php/tpoadminv1/catalogos/campanas_avisos/validate_agregar_tema" enctype="multipart/form-data" >
            <div class="box box-primary">
                <div class="box-header">
                </div><!-- /.box-header -->
                <div class="box-body">
                    <input type="hidden" value="" class="form-control" name="id_campana_tema"/>
                    <div class="form-group">
                        <label>Tema*</label>
                        <?php $class = "form-control";
                            echo form_input(array('type' => 'text', 'name' => 'nombre_campana_tema', 'value' => $tema_nombre, 'class' => $class)); ?>
                    </div>
                    <div class="form-group">
                        <label>Estatus*</label>
