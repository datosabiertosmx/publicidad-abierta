...
<?php
    ...
    for($z = 0; $z < sizeof($lista_estatus_ids); $z++)
    {
        if( $ejercicio['active'] == 'null' )
        {
            ...
            if( $lista_estatus_ids[$z] == $ejercicio['active'] ){
                $sel_estatus .= '<option value="'.$lista_estatus_ids[$z].'" selected>' . $lista_estatus[$z] . '</option>';
            }else{
                $sel_estatus .= '<option value="'.$lista_estatus_ids[$z].'">' . $lista_estatus[$z] . '</option>';
            }
...
<section class="content">
    ...
    <div class="row">
        <form role="form" method="post" action="<?php echo base_url(); ?>index.php/tpoadminv1/catalogos/catalogos/validate_agregar_ejercicio" enctype="multipart/form-data" >
            <div class="box box-primary">
                <div class="box-header">
                </div><!-- /.box-header -->
                <div class="box-body">
                    <input type="hidden" value="" class="form-control" name="id_ejercicio"/>
