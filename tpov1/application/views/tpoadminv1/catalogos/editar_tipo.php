...
<?php
    ...
    {
        if($tipo['active'] == $lista_estatus_ids[$z]){
...
<section class="content">
    ...
    <div class="row">
        <form role="form" method="post" action="<?php echo base_url(); ?>index.php/tpoadminv1/catalogos/campanas_avisos/validate_editar_tipo" enctype="multipart/form-data" >
            <div class="box box-primary">
                <div class="box-header">
                </div><!-- /.box-header -->
                <div class="box-body">
                    <input type="hidden" value="<?php echo $tipo['id_campana_tipo']?>" class="form-control" name="id_campana_tipo"/>
                    <div class="form-group">
                        <label>Tipo de campa&ntilde;a o aviso institucional*</label>
                        <?php $class = "form-control";
                            echo form_input(array('type' => 'text', 'name' => 'nombre_campana_tipo', 'value' => $tipo['nombre_campana_tipo'], 'class' => $class)); ?>
                    </div>
                    <div class="form-group">
                        <label>Estatus*</label>
                ...
                <div class="box-footer">
                    ...
                    <?php echo anchor("tpoadminv1/catalogos/campanas_avisos/busqueda_tipos", "<button class='btn btn-default' type='button'>Regresar</button></td>"); ?>
                </div>     
            </div><!-- /.box -->    
            <?php 
