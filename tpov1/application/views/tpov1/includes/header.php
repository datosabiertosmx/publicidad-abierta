	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xs-7 col-md-7">
				...
				<img title="Comisiones Abiertas" src="<?php echo base_url() . 'dist/img/Comisiones.png' ?>"
				onmouseout="this.src='<?php echo base_url() . 'dist/img/Comisiones.png' ?>';" 
				onmouseover="this.src='<?php echo base_url() . 'dist/img/Comisioneshover.png' ?>';"
				style="float: right; margin-right: 20px; max-width: 100%;  height: auto;"/>
				</a>
				<a href="http://contratacionesabiertas.inai.org.mx/contratacionesabiertas/contratos/" target="_blank">				
				<img title="Contrataciones Abiertas" src="<?php echo base_url() . 'dist/img/Contrataciones.png' ?>" 
				onmouseout="this.src='<?php echo base_url() . 'dist/img/Contrataciones.png' ?>';" 
				onmouseover="this.src='<?php echo base_url() . 'dist/img/Contratacioneshover.png' ?>';"
				style="float: right; margin-right:-184px; max-width: 100%;  height: auto;"/>
				</a>
				<a href="http://catalogodepoliticas.inai.org.mx/" target="_blank">				
				<img title="Políticas Abiertas" src="<?php echo base_url() . 'dist/img/Politicas.png' ?>" 
				onmouseout="this.src='<?php echo base_url() . 'dist/img/Politicas.png' ?>';" 
				onmouseover="this.src='<?php echo base_url() . 'dist/img/Politicashover.png' ?>';"
				style="float: right; margin-right:-256px; max-width: 100%;  height: auto;"/>
				</a>
            </div>
        </div>
	</div>
